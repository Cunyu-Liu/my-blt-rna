...
# python /home/cunyuliu/blt-main/bytelatent/checkpoint.py consolidate /home/cunyuliu/blt-main/tmp/blt-entropy-new/checkpoints/0000001000
            ...
            for folder in folder_to_remove:
                for file in self.fs.ls(folder):
                    if self.fs.isfile(file):
                        ...
                        assert os.path.basename(file) in [CONSOLIDATE_FOLDER]
